...
export class ResultadosComponent implements OnInit {
  ...
  constructor(private mdlCtrl: ModalController, public navCtrl: NavController, private httpService: HttpService, private activateRoute: ActivatedRoute) { }

  ngOnInit() {
    this.activateRoute.queryParams.subscribe(
      params => {
        this.clase =  params['tipo'];
      });
